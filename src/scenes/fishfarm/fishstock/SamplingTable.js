...
export const SamplingTable = () => {
  ...
  const getSample = () => {
    FishApi.getSamplingDataByStock(user, stockId)
  ...
  const sampleChartData = { samplingTable, avgFishSize, targetSize };
  ...
  const handleFormSubmit = () => {
    if (formData.samplingId) {
      ...
      confirm &&
        FishApi.updateSample(user, formData.samplingId, formData)
          .then(() => {
            handleClose();
            getSample();
          })
      ...
      // adding new sample
      FishApi.createSample(user, stockId, formData)
        .then(() => {
          handleClose();
          getSample();
        })
  ...
  return (
    <div>
      ...
      <div className="card shadow mb-4">
        <div className="card-header py-3">
          <h6 className="m-0 font-weight-bold text-primary">
            Sampling Reports for Stock ID {stockId} in {pondUsed}
          </h6>
        </div>
      ...
      />
       <SamplingLineChart sampleChartData={sampleChartData} />
    </div>
  );
};
