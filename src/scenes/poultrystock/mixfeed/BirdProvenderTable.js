...
import { BirdProvenderChart } from "./BirdProvenderChart";
import AddBirdProvenderDialog from "./AddBirdProvenderDialog";
...
export const BirdProvenderTable = () => {
  ...
  const getProvender = () => {
    FarmSuppliesApi.getMixedFeedByFlockId(user, flockId)
  ...
  const handleFormSubmit = () => {
    if (formData.batchId) {
      ...
      // adding new pond
      FarmSuppliesApi.createMixedFeedByFlockId(user, formData, flockId)
        .then(() => {
          handleClose();
          getProvender();
          refresh();
  ...
  return (
    <div className="container-fluid">
      ...
      <div className="card shadow mb-4">
        <div className="card-header py-3">
          <h6 className="m-0 font-weight-bold text-primary">
            Stock of prepared feed for Flock ID {flockId}. Breed: {flockType}
          </h6>
        </div>
      ...
      <BirdProvenderChart mixedFeedChartData={mixedFeedChartData} />
    </div>
  );
};
