...
export const BirdProvenderChart = ({ mixedFeedChartData }) => {
        ...
        <div className="col-xl-12 col-lg-7">
          <div className="card shadow mb-4">
            ...
            <div
              ...
              <h6 className="m-0 font-weight-bold text-primary"> Provender Usage for Flock ID {flockId}. Breed: {flockType} </h6>
              <h6 className="m-0 font-weight-bold text-secondary">Total Qty Prepared(Kgs) : {mixedFeedChartData?.totalQtyPrepared}</h6>
              <h6 className="m-0 font-weight-bold text-secondary">Total Cost-CFA : {mixedFeedChartData?.totalCost}</h6>
              <h6 className="m-0 font-weight-bold text-secondary">Total Qty Consummed(Kgs) : {mixedFeedChartData?.totalQtyConsummed}</h6>
            </div>
