...
export const BirdSamplingLineChart = ({ sampleChartData }) => {
  ...
  var data = {
    ...
    datasets: [
      {
        label: "Average Bird Size",
        data: sampleChartData?.avgBirdSize,
        backgroundColor: [
          "rgba(255, 99, 132, 0.2)",
          "rgba(54, 162, 235, 0.2)",
          "rgba(255, 206, 86, 0.2)",
          ...
          <div className="card shadow mb-4">
            ...
            <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h6 className="m-0 font-weight-bold text-primary">
                Sampling Chart for Flock ID: {flockId}. { flockType } in Stock :{" "}
                {stockRemaining}{" "}
              </h6>
            </div>
