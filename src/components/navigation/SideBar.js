export const Sidebar = () => {
  return (
    ...
    >
      ...
      <li className="nav-item">
        ...
        >
          <div className="bg-white py-2 collapse-inner rounded">
            ...
            <a className="collapse-item" href="/emprecords">
              Records
            </a>
            <a className="collapse-item" href="/soon">
              Payroll
            </a>
      ...
      <li className="nav-item">
        <a className="nav-link" href="/mixedfeed">
      ...
      <li className="nav-item">
        ...
        >
          <div className="bg-white py-2 collapse-inner rounded">
            ...
            <a className="collapse-item" href="/feedstock">
              Feed Stock
            </a>
            <a className="collapse-item" href="/feedusage">
              Feed Usage
            </a>
            <a className="collapse-item" href="/soon">
              Other Supplies
      ...
      {/* <!-- Heading --> */}
      <div className="sidebar-heading">Misc</div>
      {/* <!-- Nav Item - Charts --> */}
      <li className="nav-item">
