...
class AdminPage extends Component {
  ...
  handleDeleteUser = (username) => {
    ...
    FarmApi.deleteUser(user, username)
      .then(() => {
        this.handleGetUsers()
      })
      .catch(error => {
  ...
  handleSearchUser = () => {
    ...
    FarmApi.getUsers(user, username)
      .then(response => {
  ...
  handleCreateOrder = () => {
    ...
    FarmApi.createOrder(user, order)
      .then(() => {
        this.handleGetOrders()
